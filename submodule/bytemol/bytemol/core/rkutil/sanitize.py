...
# check rdkit version, allow 2023 and 2024
# rdkit 2025 breaks some unit tests
rk_ver = version.parse(rdkit.rdBase.rdkitVersion)
if rk_ver.major < 2023 or rk_ver.major >= 2025:
    raise RuntimeError(f"Unsupported RDKit version {rk_ver}; supported major versions are 2023-2024.")
